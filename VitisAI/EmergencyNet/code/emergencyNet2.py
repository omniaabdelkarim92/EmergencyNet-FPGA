...
class AtrousBlock(nn.Module):
    def __init__(self, in_channels, channels, out_channels=32, kernel_size=3, stride=1, act='l', dropout_rate=None,
                 fusion_type='add'):
        super(AtrousBlock, self).__init__()
        self.redu_r = channels      # Predefined number of intermmediate channels
...
class ACFFModel(nn.Module):
    def __init__(self, num_classes):
        ...
        self.block1 = AtrousBlock(32, 16, 64, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool1 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block2 = AtrousBlock(64, 32, 96, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block3 = AtrousBlock(96, 48, 128, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool3 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block4 = AtrousBlock(128, 64, 128, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.pool4 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.block5 = AtrousBlock(128, 64, 128, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
        self.block6 = AtrousBlock(128, 64, 256, kernel_size=3, stride=1, act='l', dropout_rate=None, fusion_type='add')
