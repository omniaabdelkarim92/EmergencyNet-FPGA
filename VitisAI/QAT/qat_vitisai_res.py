...
Usage example (inside Vitis-AI docker):
    python qat_vitisai.py \
      --model_class ACFFModel \
      --model_file code/emernet_v1.py \
      --fp32_ckpt ./build/float/emergencyNetv12_best.pth \
...
fp32_ckpt = "/files/build/float/resnet18_aider_best.pth"
