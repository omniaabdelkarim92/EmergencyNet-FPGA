...
class ResNet(torch.nn.Module):
    def __init__(self):
        ...
        self.module_2 = py_nndct.nn.ReLU(inplace=True) #ResNet::ResNet/ReLU[relu]/2700
        ...
        self.module_46 = py_nndct.nn.ReLU(inplace=True) #ResNet::ResNet/Sequential[layer4]/BasicBlock[1]/ReLU[relu]/input.109
        self.module_47 = py_nndct.nn.AdaptiveAvgPool2d(output_size=1) #ResNet::ResNet/AdaptiveAvgPool2d[avgpool]/3237
        self.module_48 = py_nndct.nn.Module('flatten') #ResNet::ResNet/input.111
        self.module_49 = py_nndct.nn.Linear(in_features=512, out_features=256, bias=True) #ResNet::ResNet/Sequential[fc]/Linear[0]/input.113
        self.module_50 = py_nndct.nn.ReLU(inplace=True) #ResNet::ResNet/Sequential[fc]/ReLU[1]/input.115
        self.module_51 = py_nndct.nn.Linear(in_features=256, out_features=5, bias=True) #ResNet::ResNet/Sequential[fc]/Linear[3]/3246
    ...
    def forward(self, *args):
        ...
        output_module_42 = self.module_48(input=output_module_42, start_dim=1, end_dim=3)
