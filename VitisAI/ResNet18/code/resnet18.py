...
# ----------------------------
# Modified ResNet backbones with custom head
# ----------------------------
...
if args.backbone == 'resnet18':
    model = resnet18_aider(num_classes=num_classes).to(device)
elif args.backbone == 'resnet34':
    model = resnet34_aider(num_classes=num_classes).to(device)
elif args.backbone == 'resnet50':
    model = resnet50_aider(num_classes=num_classes).to(device)
